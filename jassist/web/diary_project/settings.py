...
ACCOUNT_ADAPTER = 'jassist_app.adapters.NoSignupAccountAdapter'
SOCIALACCOUNT_ADAPTER = 'jassist_app.adapters.GoogleOnlySocialAccountAdapter'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'diary.log',
            'formatter': 'verbose',
        },
        'api_file': {
            'level': 'DEBUG',
